...
#<<<<<<< copilot/fix-604797ec-fc3e-4f08-9cf7-9ec8ce09799a
print_test() {
...
# Test 10: Script has proper shebang and executable permissions
test_script_permissions() {
    local first_line=$(head -1 "$SCRIPT_PATH")
    [[ "$first_line" == "#!/bin/bash" ]] && [[ -x "$SCRIPT_PATH" ]]
}
...
main() {
    ...
    run_test "Script has proper permissions" "test_script_permissions"
